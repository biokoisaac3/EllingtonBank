  ...
  useEffect(() => {
    if (passcode.length === 4) {
      const t = setTimeout(() => {
        if (passcode === "1234") {
          router.replace({
            pathname: "/(root)/cards/physical-card/pin/confirm-pin",
            params: params,
          });
        } else {
          setError(true);
  ...
  return (
    <SafeAreaView className="flex-1 bg-primary-100">
      ...
      <View className="flex-1 justify-between px-6 pb-12">
        <View>
          <CustomText secondary className="mb-12">Always keep your Card PIN private</CustomText>
          <CustomText>Enter your Pin</CustomText>
